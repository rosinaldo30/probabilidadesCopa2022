...
jogoscopa = pd.read_excel('dados/outputEstimativasJogosCopa2.xlsx', index_col = 0)
st.table(jogoscopa[['grupo', 'seleção1', 'seleção2', 'Vitória', 'Empate', 'Derrota']])


st.markdown('---')
st.markdown('Trabalho desenvolvido por Rosinaldo Alves com orientação do (Minicurso FLAI Data Science na Copa do Mundo!)')
